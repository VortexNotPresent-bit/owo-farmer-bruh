...
console.log("opened vortex client");
            ...
            function (error, response, body) {
                ...
                if (
                    ...
                    console.log(
                        ...
                        //cod ed by @vortex himself on github
                    );
                                ...
                                if (quest.includes("Say 'owo'")) {
                                    ...
                                    if (quest.includes("Gamble")) {
                                        ...
                                        return questgamble(
                                            token,
                                            channelid,
                                            parseInt(progress1), //coded by vortex himself
                                            parseInt(progress2),
                                            tokentype,
                                            quest
                                        );
                                ...
                                if (global.etoken) {
                                    if (
                                        ...
                                        if (tokentype == "Main Token") {
                                            ...
                                            global.extracheckquest = false; //coded by vortex himself
                                            return questprayme(
                                                maintoken,
                                                extratokenuserid,
                                                mainautoquestchannelid,
...
//training myself, for better future, for the love for him <3
